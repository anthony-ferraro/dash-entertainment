      ...
      <div>
        <div className={styles.icons}>
          ...
          <Link passHref={true} href="/">
            <svg className={`${styles.icon} ${router.pathname==="/" ?  styles.active : ""}`} width="20" height="20" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link passHref={true} href="/bookmarks">
            <svg className={`${styles.icon} ${router.pathname==="/bookmarks" ?  styles.active : ""}`} width="17" height="20" xmlns="http://www.w3.org/2000/svg">
