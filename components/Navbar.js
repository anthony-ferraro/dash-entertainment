      ...
      <div>
        <div className={styles.icons}>
          ...
          <Link passHref={true} href="/">
            <svg className={`${styles.icon} ${router.pathname === "/" ? styles.active : ""}`}width="30" height="30" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" enable-background="new 0 0 512 512">
